...
const description =
  'Coding agents can make CI pass. Vigilis makes sure it should: it heals safe test drift, refuses real regressions, and signs every decision in CI. Built by Piyush Pathak.';
